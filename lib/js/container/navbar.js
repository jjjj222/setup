import { OnehotNav } from "./onehot_nav.js"
...
export function Navbar(parent) {
    ...
    this.front_list = new Nav(this.root, "navbar-nav");
}

//------------------------------------------------------------------------------
Navbar.prototype.setAddFront = function(is_add_front) {
    this.front_list.setAddFront(is_add_front);
}
...
//------------------------------------------------------------------------------
//Navbar.prototype.add = function(text, callback) {
//    return this.front_list.add(text, callback);
//}

//------------------------------------------------------------------------------
//Navbar.prototype.addItem = function(text, callback) {
//    this.add(text, callback);
//    //const fn = () => {
